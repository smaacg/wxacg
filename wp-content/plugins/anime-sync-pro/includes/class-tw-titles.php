...
class Anime_Sync_TW_Titles {
	...
	private const MANUAL_OVERRIDES = [
		...
		/*
		 * 異體字差異：Bangumi 寫「炮」、站上用「砲」。兩邊都不是簡體，
		 * 簡繁轉換動不到。而該作品的 anime_title_simplified 是「某科学的超电磁炮」，
		 * 自動對照表只產得出「某科學的超電磁炮」這一個鍵，對不上簡介裡的其他寫法。
		 *
		 * 實測簡介裡共有六種寫法，其中「某科學的超電磁炮」已由自動表涵蓋，
		 * 其餘在此補上。「某科學的超電磁砲S」用的是站上的「砲」但多了「某」與
		 * 缺少空格，也一併收。
		 */
		'科學超電磁炮'     => '科學超電磁砲',
		'超電磁炮'         => '科學超電磁砲',
